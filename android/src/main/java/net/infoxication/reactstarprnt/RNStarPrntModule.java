...
public class RNStarPrntModule extends ReactContextBaseJavaModule {
    ...
    public void connect(final String portName, final String emulation, final Boolean hasBarcodeReader,
        ...
        try {
            mBluetoothManager = StarBluetoothManagerFactory.getManager(portName, portSettings, 10000,
    ...
    private void setAutoConnect(Boolean autoConnectEnabled, Promise promise) {
        if (mBluetoothManager
                .getAutoConnectCapability() == StarBluetoothManager.StarBluetoothSettingCapability.SUPPORT) {
