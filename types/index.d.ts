...
export enum PrinterEvent {
  ...
  PRINTER_PAPER_READY = 'printerPaperReady',
  PRINTER_PAPER_NEAR_EMPTY = 'printerPaperNearEmpty',
  PRINTER_PAPER_EMPTY = 'printerPaperEmpty',
  PRINTER_COVER_OPEN = 'printerCoverOpen',
  PRINTER_COVER_CLOSE = 'printerCoverClose',
  CASH_DRAWER_OPEN = 'cashDrawerOpen',
  CASH_DRAWER_CLOSE = 'cashDrawerClose',
  BARCODE_READER_IMPOSSIBLE = 'barcodeReaderImpossible',
  BARCODE_READER_CONNECT = 'barcodeReaderConnect',
  BARCODE_READER_DISCONNECT = 'barcodeReaderDisconnect',
  BARCODE_READER_DATA_RECEIVE = 'barcodeReaderDataReceive',
}
