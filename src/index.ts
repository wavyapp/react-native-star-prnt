...
export enum PrinterSearchErrorCodes {
  PRINTER_SEARCH_ERROR_NO_BLUETOOTH = 'PRINTER_SEARCH_ERROR_NO_BLUETOOTH',
  PRINTER_SEARCH_ERROR = 'PRINTER_SEARCH_ERROR',
  PRINTER_SEARCH_ERROR_BLUETOOTH_PERMISSION_DENIED = 'PRINTER_SEARCH_ERROR_BLUETOOTH_PERMISSION_DENIED', // Android only
}

export enum PrinterPrintErrorCodes {
