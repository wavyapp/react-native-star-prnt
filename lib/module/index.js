...
const ReactNativeStarPrinter = NativeModules.ReactNativeStarPrinter ? NativeModules.ReactNativeStarPrinter : new Proxy({}, {
  get() {
    throw new Error(LINKING_ERROR);
  }
});
export class StarPrinter {
  _nativeEventEmitter = new NativeEventEmitter(ReactNativeStarPrinter);
  static getInstance() {
...
export let PrinterEvent = /*#__PURE__*/function (PrinterEvent) {
...
export let InterfaceType = /*#__PURE__*/function (InterfaceType) {
...
export let PrinterOpenErrorCodes = /*#__PURE__*/function (PrinterOpenErrorCodes) {
...
export let PrinterGetStatusErrorCodes = /*#__PURE__*/function (PrinterGetStatusErrorCodes) {
...
export let PrintDataType = /*#__PURE__*/function (PrintDataType) {
...
export let PrintAction = /*#__PURE__*/function (PrintAction) {
...
export let RuleLineStyle = /*#__PURE__*/function (RuleLineStyle) {
  RuleLineStyle["SINGLE"] = "single";
  RuleLineStyle["DOUBLE"] = "double";
  return RuleLineStyle;
}({});
export let PrintInternationalCharacterType = /*#__PURE__*/function (PrintInternationalCharacterType) {
...
export let DisplayInternationalCharacterType = /*#__PURE__*/function (DisplayInternationalCharacterType) {
...
export let DisplayCursorState = /*#__PURE__*/function (DisplayCursorState) {
  DisplayCursorState["ON"] = "on";
  DisplayCursorState["OFF"] = "off";
  DisplayCursorState["BLINK"] = "blink";
  return DisplayCursorState;
}({});
export let PrinterSearchErrorCodes = /*#__PURE__*/function (PrinterSearchErrorCodes) {
...
export let PrinterPrintErrorCodes = /*#__PURE__*/function (PrinterPrintErrorCodes) {
